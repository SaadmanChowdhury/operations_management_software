<?php
    ...
    return [
        ...
        'Business_situation' => [
            ...
            '積中' => 1,    //During loading        //config('constants.Business_situation.積中')
            '見積提示済' => 2,    //Presented Estimation  //config('constants.Business_situation.見積提示済')
        ...
        'Development_stage' => [
            ...
            '設計' => 2,    // 設計/製造-Design/manufacturing   //config('constants.Development_stage.設計')
