                ...
                <div id="table-nav" class=" _assign mild-yellow text-medium">
                    ...
                    <div class="assign-header-sub-row mild-yellow ">
                        <div class="text-center text-lg d-flex text-medium" style="align-items: center">
                            ...
                            <span class="fa fa-caret-left" onclick="year_dec()"></span>
                            <p id="assign_year">2020</p>
                            <span class="fa fa-caret-right" onclick="year_inc()"></span>
                        </div>
                    </div>
    ...
    <script>
        ...
        function showAssignedUserByPosition(position) {
            ...
            var rows = document.querySelectorAll(
                "#assign_summary_table > div > div.d-flex.assign-user-sub-row._header.list-unstyled.text-center");
        ...
        function addAssignCategoryListeners() {
            ...
            var categories = document.querySelectorAll(
                "body > div.page-container > div.d-flex > div > div > div:nth-child(1) > ul:nth-child(2) > a ");
        ...
        function addAssignCategoryListenersByPosition() {
            var posBtns = document.querySelectorAll(
                "body > div.page-container > div.d-flex > div > div > div:nth-child(1) > ul:nth-child(1) > a");
